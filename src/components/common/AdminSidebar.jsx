...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { path: '/admin/policies', label: t('admin.policies'), icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
      </svg>
    )},
    { path: '/admin/announcements', label: t('admin.announcements'), icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { path: '/admin/issues', label: t('admin.issues'), icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <span 
              className={`
                ...
                ${({ isActive }) => isActive ? 'bg-white' : 'bg-transparent'}
              `}
            />

            <span className={`mr-4 transition-transform duration-200 group-hover:scale-110 ${({ isActive }) => isActive ? 'text-white' : 'text-white/70'}`}>
              {item.icon}
            </span>
            <span className="font-medium text-sm tracking-wide transition-transform duration-200 group-hover:translate-x-1">
              {item.label}
            </span>
          </NavLink>
        ))}
