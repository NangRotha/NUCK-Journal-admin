...
const IssueList = ({ issues, onDelete, onSetCurrent }) => {
          ...
          <tbody className="divide-y divide-white/10">
            {issues.map((issue, index) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  {issue.is_current ? (
                    <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-green-100/80 text-green-800 backdrop-blur-sm">
                      ✓ Current
                    </span>
                  ) : (
                ...
                <td className="px-6 py-4 text-right space-x-3">
                  {!issue.is_current && (
                    <button
                      onClick={() => onSetCurrent(issue.id)}
                      className="text-blue-600 hover:text-blue-800 text-sm font-medium transition-colors duration-200 hover:underline inline-flex items-center gap-1"
                    >
